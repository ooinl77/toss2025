...
export class LifecycleClass extends Component {
  ...
  componentDidUpdate() {
    console.log(`컴퍼넌트가 업데이트${this.state.count} 되었습니다.`);
  }
...
export function LifecycleFunc() {
  ...
  //마운트 & 언마운트
  useEffect(() => {
    console.log("컴퍼넌트가 마운트 되었을 때");
    return () => {
      console.log("컴퍼넌트가 언마운트 되었을 때");
    };
  }, []); // 빈배열을 넣으면, 마운트 / 언마운트시 한 번만 호출됨
  //업데이트
  useEffect(() => {
    console.log("컴퍼넌트가 업데이트 되었을 때");
